...
@implementation YYRangePicker
{
    NSMutableArray *_smallList;
    NSMutableArray *_bigList;
}

-(instancetype)initWithRangeFrom:(int)min to:(int)max unit:(NSString*)unit done:(YYRangeSelected)selected
{
    if (self = [super init])
    {
...
{
    _done(_smallIndex + _minNumber,_smallIndex + _minNumber + _bigIndex);
}
